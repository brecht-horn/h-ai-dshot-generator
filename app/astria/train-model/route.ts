    ...
    const body = {
      tune: {
        ...
        prompts_attributes: [
          ...
          {
            text: `face like a character from the Toy Story movies, ohwx ${type} wearing a business suit, photo accurate hair color, photo accurate eyebrow color, animated park in the city with benches background, disney style, dreamworks style`,
