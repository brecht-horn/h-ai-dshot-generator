  ...
  try {
    ...
    const body = {
      tune: {
        ...
        prompts_attributes: [
          {
            text: `1985 yearbook photo portrait of ohwx ${type} wearing a 1980's outfit, retro hairstyle,  accurate hair color, Amazing Details, Best Quality, Masterpiece, analog photo`,
