      ...
      <div className='flex flex-col lg:flex-row items-center gap-8 p-8 max-w-6xl w-full'>
        <div className='flex flex-col space-y-4 lg:w-1/2 w-full'>
          <h1 className='text-5xl font-bold text-violet-400/100'>
            Retro, Animated, or Professional AI Headshots in minutes.
          </h1>
          <p className='text-white text-lg'>
            Elevate your online presence with unique headshots generated by our
            AI. Perfect for social profiles, resumes, and professional portfolios.
          </p>
